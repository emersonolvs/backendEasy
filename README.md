...
O Problema: A necessidade de um back-end em Java capaz de operar um chatbot funcional no WhatsApp, com foco em automação básica de atendimento e respostas automatizadas.
...
Estrutura de Banco de Dados: Diagrama de Entidade-Relacionamento, para mostrar visualmente as tabelas, suas colunas e como elas se conectam.

Lógica de Funcionamento: Fluxograma, para representar a arquitetura e o fluxo de dados da solução
